...
\begin{minipage}[t]{0.2\textwidth} % 20% of the page width for the first row of icons
    ...
    \icon{Phone}{11}{\small{+1 360 216 9074}}\\
    \icon{MapMarker}{11}{Kiel, Germany}\\
	
\end{minipage}
\begin{minipage}[t]{0.27\textwidth} % 27% of the page width for the second row of icons
	\vspace{-\baselineskip} % Required for vertically aligning minipages
	
	\icon{Envelope}{11}{\href{mailto:bweek@uoregon.edu}{bweek.ecoevo@proton.me}}\\
    \orcid{11}{\href{https://orcid.org/0000-0001-7687-4757}{0000-0001-7687-4757}}\\
...
\begin{entrylist}
    \entry
        ...
        {\href{https://www.iids.uidaho.edu/about.php}{KiTE, Kiel University}}
