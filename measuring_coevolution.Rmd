...
```{r, message=FALSE, fig.align='center', fig.cap="Figure 2: Displayed in this scatter plot are mean trait pairs for various locations across Japan. The colours indicate which island these locations belong to."}
# plot data
library(ggplot2)
library(ggdark)
library(gapminder)
