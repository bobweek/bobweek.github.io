...
This is a tutorial for employing the method of coevolutionary inference described in Week & Nuismer ([2019](https://doi.org/10.1111/ele.13231)). Data used in this tutorial comes from Toju & Sota ([2006](https://doi.org/10.1086/498277)) and have been collected [here](https://github.com/bobweek/measuring.coevolution) for convenience. All analysis is done in the statistical programming language R.
