...
author: "**Bob Week** 🦠 KiTE Postdoc ~ Schulenburg Group 🪱 *Kiel University*"
format:
  revealjs:
    theme: white
    css: daytime.css
    ...
    include-in-header:
      text: |
        <script>The Response of Genetic Correlations to Drift
...
![](wf_correlations_2.gif){fig-align="center"}
