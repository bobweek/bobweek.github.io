...
If $R\subset\mathbb{R}$ denotes the range of the species, then (assuming abundance is constant across space) the global mean trait of species $i$ at time $t$ is given by

$$\mu_i(t)\equiv\frac{1}{|R|}\int_R\bar z_i(x,t)dx$$

and the variance in local mean traits by

$$V_i(t)\equiv\frac{1}{|R|}\int_R(\bar x_i(x,t)-\mu_i(t))^2dx$$

and the covariance by

$$C(t)\equiv\frac{1}{|R|}\int_R(\bar x_1(x,t)-\mu_1(t))(\bar x_2(x,t)-\mu_2(t))dx.$$
