...
If $n_i(x)$ denotes abundance density of species $i$, the global mean trait of species $i$ at time $t$ is given by

$$\mu_i(t)\equiv\frac{\int_\R\bar z_i(x,t)n_i(x)dx}{\int_\R n_i(y)dy}$$

and the variance in local mean traits by

$$V_i(t)\equiv\frac{\int_\R(\bar x_i(x,t)-\mu_i(t))^2n_i(x)dx}{\int_\R n_i(y)dy}$$

and the covariance by

$$C(t)\equiv\frac{\int_\R(\bar x_1(x,t)-\mu_1(t))(\bar x_2(x,t)-\mu_2(t))n_1(x)n_2(x)dx}{\int_\R n_1(y)n_2(y)dy}.$$
