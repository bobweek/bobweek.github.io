...
$$\mathbb{E}\frac{dN_t}{dt}=r(t)N_t=\left(\int_0^ta(s)ds+e^{\int_0^tb(s)ds-t}+c\right)N_t.$$

We can then solve for the mean population size as a function of time to get

$$\mathbb{E}N_t=\left(\mathbb{E}N_0\right)e^{\int_0^tr(s)ds}.$$
