...
padding:15px;
margin:5px;"><b>
I am a PhD candidate at the University of Idaho advised by Professor [Scott Nuismer](https://www.leeef.org) and planning to graduate June 2020. My degree program is Bioinformatics and Computational Biology ([BCB](https://www.uidaho.edu/sci/bcb)) which is housed within The Institute for Bioinformatics and Evolutionary Studies ([IBEST](http://www.ibest.uidaho.edu/)). My CV is available [here](bob_week.pdf).
</b>
</p>
...
padding:15px;
margin:5px;"><b>
My dissertation contributes to a coevolutionary theory of community ecology with a focus on plant-pollinator networks. In particular, I have recently developed a Maximum Likelihood method to infer the strength of coevolution between a pair of species using spatially structured phenotypic data ([Week 2019](https://onlinelibrary.wiley.com/doi/abs/10.1111/ele.13231)). I am currently finishing a project applying Measure-Valued Branching Processes and Stochastic Partial Differential Equations to formally derive stochastic models of coevolving communities. Working with Professor [Paul CaraDonna](https://paulcaradonna.weebly.com/), we plan on using this new set of tools to develop an Approximate Bayesian Computation to infer the distribution of phenological coevolution in a sub-alpine plant-pollinator network.
</b>
</p>
