...
Coevolution has long been thought to drive the exaggeration of traits [@darwin1859origin;@ehrlich1964butterflies], promote major evolutionary transitions such as the evolution of sexual reproduction [@hamilton1980sex;@jaenike1978hypothesis;@lively1987evidence;@gandon2007evolution], and influence epidemiological dynamics [@anderson1982coevolution;@lion2015evolution;@lively2016coevolutionary]. Despite coevolution's long suspected importance, however, our understanding of both the mechanisms involved and the patterns produced by this process is still in its infancy (cite one of scott's papers where he's bitchin about thompson). To truly grasp the role that coevolution plays in shaping the diversity of life we must, at the very least, account for the details of the mechanisms driving the coevolutionary process, quantify its strength in nature, and determine its consequences on ecological communities. 

Previous work in this area has focused on results pertaining to a small number of interacting species (cite roughgarden, abrams, holt and mcpeek). However, many of the patterns observed span dozens, even hundreds of species [manning and goldblatt, hubbel]. To overcome this a recent development in coevolutionary theory has taken the so-called mean field approach (cite paper that's in review and scott's 2013 paper). This approach allows the reduction of a high-dimensional problem involving equations describing the evolution of each species within a community to a low-dimensional one that focuses on the community as a whole. With this approach we can derive analytical results pertaining to the statistical nature of communities as whole, but without explicit conclusions for any particular member of the community. Hence, the stage has been set to develop a mathematically rigorous theory of coevolutionary community ecology. The primary goal of this work is to contribute to this development by extending previous work on the coevolution of communities to the context of mutualistic networks.

However, before such a contribution can be made there are two major steps to be taken. First, a more biologically realistic treatment of the mechanisms mediating the outcomes of ecological interactions needs to be incorporated into coevolutionary theory. This alone may explain a significant amount of variability seen in nature. Second, a metric of the strength of coevolution within a community is required to quantify the role of coevolution in shaping communities. To derive this community-wide metric from first principles I will first need a way to measure the strength of coevolution between a pair of species (hereon referred to as pairwise coevolution). Accomplishing these first two steps will brandish a framework ripe for rigorous investigations of the relationship between coevolution and ecological communities. To tether this work to the empirical world, I motivate each step by the details of specific pollination networks. The three primary questions driving this work are:
...
Given the logic of Darwins argument, we might expect pollination-based mutualisms to consistently produce highly exaggerated traits. However, we instead see a wide variety in the degree of exaggeration among traits mediating such interactions [@anderson2010predictable].
