...
The long-proboscid fly, M. longirostris, resides in lowland habitats near the coast of South Africa and pollinates a guild of at least 20 plant species [@manning1997themoegistorhynchus]. Among these species, the most widespread is L. anceps, a long-tubed perennial whose distribution extends outside the range of M. longirostris [@pauw2009flies]. Crucial to our analysis, we were able to estimate the likely optimal tube and proboscis lengths for these species in the absence of this particular interaction. Using the phenotypic data published by [@pauw2009flies], we inferred these parameters by averaging the trait values of additional species within the pollination assemblage. Details of the methods used to calculate other background parameters can be found in the supplementary information (SI \S\ref{data}). We found that the biotic selection strengths $B_1$ and $B_2$ on M. longirostris and L. anceps, respectively, do not statistically differ from zero ($p_1\approx$ 0.968, $p_2\approx$ 0.736, see @networkfig). Thus, our analysis fails to support the hypothesis of strict pairwise coevolution in this system. Our failure to find evidence of pairwise coevolution in this interaction may result from its actual absence or because the richness of the plant-pollinator community creates a scenario where coevolutionary selection is more diffuse and driven by a large number of weak pairwise interactions [@fox1988diffuse; @strauss2005toward]. In such a case, our approach may not be sufficiently powerful to detect the weak coevolution attributable to a single pairwise interaction. It is also possible that coevolution in this system is driven largely by indirect effects, undetectable with our approach, as has been recently suggested by [@guimaraes2017indirect].
