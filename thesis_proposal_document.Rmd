...
```{r networkfig, echo=F, fig.cap="Relationships between the coevolutionary hypothesis and non-coevolutionary hypotheses", fig.align='center', anchor="figure"}
...
The parameters I anticipate to be most important in determining when specialization will occur are the strengths of biotic selection ($B$) and the optimal offset ($\delta$). By imposing specific statistical distributions on these parameters across the community, I might find, for example, that a high variance in $\delta$ inevitably leads to the specialization in interactions between a subset of the community. 
