...
Blah blah blah. Some stuff about stuff and stuff. When the $\gamma$ is $\mathbb{R}^2$ we all know what to do:

$$y=mx+b.$$


Let's try SVL and body width.
...
All better. Now I'm going to partition the data into two groups and test to see the members of each group are monophyletic.
...
grp2 <- which(pcd[,1]<=(yint+slope*pcd[,2]))
```
