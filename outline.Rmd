...
This is an attmept to synthesize coevolutionary theory and community ecology. Why these two topics? In my mind they each hold the potential to capture the 
...
Aside from whether or not species interact, we curious to know as to how often they interact. Given that an individual is in the midst of an interaction, we might draw the identity of the species it is interacting with from a distribution. Then it makes sense to quantify the rates of interaction by convex combinations of all members of the community. These convex combinations represent behaviour and can also evolve.
...
Turnover, the instantaneous expectation of flux of resident species, can be used to measure maturity. As turnover approaches zero, the community can be said to reach __ultimate maturity__. This implicitly involves stabilization of demographic dynamics. Invasion rate = $\nu$, local extinction rate = $\varepsilon$, community flux = $\nu+\varepsilon$.

Let $E_T\geq0$ be a random variable representing the number of extinctions within the time interval $T=(t_1,t_2)$. Then

$$\varepsilon\equiv\lim_{t_2\downarrow t_1}\frac{\E(E_T)}{t_2-t_1}.$$

Let $I_T\geq0$ be the number of invasions that occur within the same time interval $T$. Then

$$\nu\equiv\lim_{t_2\downarrow t_1}\frac{\E(I_T)}{t_2-t_1}.$$
...
For a birth event, we could draw a Poisson distributed number of offspring. But I wonder if it would be more tractable to just increase the rate of birth instead? Then rate of birth is associated with fitness. So is rate of death. These life-history traits become directly linked to everything else.
  ...
  * $B_T(i,z)\dots$ number of births within time interval $T$ for an individual of species $i$ with trait $z$
  * $D_T(i,z)\dots$ probability of death within time interval $T$ for an individual of species $i$ with trait $z$
...
$$\E(B_\Delta|\Delta)=b\Delta.$$

If $\E(\Delta)=\tau_d$ then the expected fitness of the organism is
...
### Chapters
  ...
  * What is coevolution?
    * Start with Janzen's definition and discuss the implied triviality of coevolution
    * Move on to the community context and diffuse coevolution
    * From here go on to your definition of pairwise coevolution
  * The measurement of coevolution
    * Start with the Week-Nuismer-2017 (WN17) method and discuss all of it's shortcomings
    * Move on to ways of measuring these more refined notions of coevolution discussed in the prev chapter
  * Coevolution and community assembly
    * Succession
    * Invasion
  * Coevolution and evolution of specialization

## Research Questions

  * How common is pairwise coevolution?
  * How does community assembly interact with coevolution?
  * How does invasion interact with coevolution?
  * Under what conditions do specialist species evolve?
  * Is the evolution of specialist species associated with evolution of nestedness?
...
#### __Aim 0: Find a way to measure the strength of coevolution in nature.__
...
#### __Aim 2: Determine the relationship between coevolution and the rate of succession.__
...
#### __Aim 3: Determine the relationship between coevolution, community maturity and invasibility.__
...
#### __Aim 4: Determine the necessary and sufficient conditions for the evolution of specialization.__
...
#### __Aim 5: Determine the relationship between the evolution of specialization and nestedness.__
